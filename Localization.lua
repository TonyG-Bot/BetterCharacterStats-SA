...
BCS["L_esES"] = {
    ...
    ["^Set: Improves your chance to hit with spells by (%d)%%."] = "^Conjunto: Mejora tu probabilidad de acertar con hechizos en un (%d)%%.",
    ["^Set: Increases damage and healing done by magical spells and effects by up to (%d+)%."] = "^Conjunto: Aumenta el daño y la sanación realizados por hechizos y efectos mágicos hasta en un (%d+)%.",
    ["^Set: Increases healing done by spells and effects by up to (%d+)%."] = "^Conjunto: Aumenta la sanación realizada por hechizos y efectos hasta en un (%d+)%.",
    ...
    ["^Set: Improves your chance to get a critical strike by (%d)%%."] = "^Conjunto: Mejora tu probabilidad de golpe crítico en un (%d)%%.",
    ["^Set: Restores (%d+) mana per 5 sec."] = "^Conjunto: Restaura (%d+) de maná cada 5 segundos.",

    -- scythe
	["Equip: Improves your chance to hit and get a critical strike with spells by 2%%. Increases damage done by magical spells and effects by up to 40."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Mejora tu probabilidad de acertar y obtener un golpe crítico con hechizos en un 2%%. Aumenta el daño causado por hechizos y efectos mágicos en hasta 40.",
    ...
    ["Increases your critical strike chance with all attacks by (%d)%%."] = "Aumenta tu probabilidad de golpe crítico con todos los ataques en un (%d)%%.",
    ["Increases spell damage and healing by up to (%d+)%% of your total Spirit."] = "Aumenta el daño y la sanación de los hechizos hasta en un (%d+)%% de tu Espíritu total.",
    ...
    ["Reduces the chance that the opponent can resist your Frost and Fire spells by (%d)%%."] = "Reduce la probabilidad de que el enemigo resista tus hechizos de Escarcha y Fuego en un (%d)%%.",
    ["Reduces the chance that the opponent can resist your Arcane spells by (%d+)%%."] = "Reduce la probabilidad de que el enemigo resista tus hechizos de Arcano en un (%d+)%%.",
    ["Reduces your target's chance to resist your Shadow spells by (%d+)%%."] = "Reduce la probabilidad de que tu objetivo resista tus hechizos de Sombras en un (%d+)%%.",

    ["Equip: Increases damage done by Arcane spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Arcano hasta en un (%d+).",
    ["Equip: Increases damage done by Fire spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Fuego hasta en un (%d+).",
    ["Equip: Increases damage done by Frost spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Escarcha hasta en un (%d+).",
    ["Equip: Increases damage done by Holy spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Sagrado hasta en un (%d+).",
    ["Equip: Increases damage done by Nature spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Naturaleza hasta en un (%d+).",
    ["Equip: Increases damage done by Shadow spells and effects by up to (%d+)."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta el daño causado por hechizos y efectos de Sombras hasta en un (%d+).",
    ...
    -- Auras
    ["Critical strike chance increased by (%d+)%%."] = "Probabilidad de golpe crítico aumentada en un (%d+)%%.",
    ["Chance to hit increased by (%d)%%."] = "Probabilidad de acertar aumentada en un (%d)%%.",
    ["Magical damage dealt is increased by up to (%d+)."] = "El daño mágico infligido aumenta en hasta (%d+).",
    ["Healing done by magical spells is increased by up to (%d+)."] = "Sanación realizada por hechizos mágicos aumentada en hasta (%d+).",
    ...
    ["Healing increased by up to (%d+)."] = "Sanación aumentada hasta en un (%d+).",
    ["Healing spells increased by up to (%d+)."] = "Hechizos de sanación aumentados hasta en un (%d+).",
    ["Chance to hit reduced by (%d+)%%."] = "Probabilidad de acertar reducida en un (%d+)%%.",
    ...
    ["Chance for a critical hit with a spell increased by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos aumentada en un (%d+)%%.",
    ["While active, target's critical hit chance with spells and attacks increases by 10%%."] = "Mientras está activo, la probabilidad de golpe crítico con hechizos y ataques del objetivo aumenta en un 10%%.",
    ["Increases attack power by %d+ and chance to hit by (%d+)%%."] = "Aumenta el poder de ataque en %d+ y la probabilidad de acertar en un (%d+)%%.",
    ["Holy spell critical hit chance increased by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos sagrados aumentada en un (%d+)%%.",
    ["Destruction spell critical hit chance increased by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos de destrucción aumentada en un (%d+)%%.",
    ["Arcane spell critical hit chance increased by (%d+)%%.\r\nArcane spell critical hit damage increased by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos arcanos aumentada en (%d+)%%.\r\nDaño crítico con hechizos arcanos aumentado en un (%d+)%%.",
    ["Spell hit chance increased by (%d+)%%."] = "Probabilidad de acertar con hechizos aumentada en un (%d+)%%.",
    ["Agility increased by 25, Critical hit chance increases by (%d)%%."] = "Agilidad aumentada en 25, probabilidad de golpe crítico aumentada en un (%d)%%.",
    ["Increases chance for a melee, ranged, or spell critical by (%d+)%% and all attributes by %d+."] = "Aumenta la probabilidad de golpe crítico cuerpo a cuerpo, a distancia o con hechizos en un (%d+)%% y todos los atributos en un %d+.",
    ["Spell critical-hit chance reduced by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos reducida en un (%d+)%%.",
    ["Increases critical chance of spells by 10%%, melee and ranged by 5%% and grants 140 attack power. 120 minute duration."] = "Aumenta la probabilidad de golpe crítico con hechizos en un 10%%, cuerpo a cuerpo y a distancia en un 5%% y otorga 140 de poder de ataque. Duración de 120 minutos.",
    ["Critical strike chance with spells and melee attacks increased by (%d+)%%."] = "Probabilidad de golpe crítico con hechizos y ataques cuerpo a cuerpo aumentada en un (%d+)%%.",
    ["Increases ranged and melee critical chance by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico a distancia y cuerpo a cuerpo en un (%d+)%%.",
    ["Equip: Increases the critical chance provided by Leader of the Pack and Moonkin Aura by (%d)%%."] = ITEM_SPELL_TRIGGER_ONEQUIP .. " Aumenta la probabilidad de golpe crítico otorgada por Líder de la manada y Aura de lechúcico lunar en un (%d)%%.",
    ...
    -- Paladín
    ["Increases your healing power by (%d+)%% of your Armor."] = "Aumenta tu poder de sanación en un (%d+)%% de tu armadura.",
    ["Increases the critical effect chance of your Holy Light and Flash of Light by (%d+)%%."] = "Aumenta la probabilidad de efecto crítico de tus hechizos Luz Sagrada y Destello de Luz en un (%d+)%%.",
    ["Improves your chance to get a critical strike with Holy Shock by (%d+)%%."] = "Mejora tu probabilidad de golpe crítico con Choque Sagrado en un (%d+)%%.",
    ["Increases your chance to hit with melee attacks and spells by (%d+)%%."] = "Aumenta tu probabilidad de acertar con ataques cuerpo a cuerpo y hechizos en un (%d+)%%.",

    ["Increases your armor value from items by (%d+)%%."] = "Aumenta el valor de tu armadura de los objetos en un (%d+)%%.",
    ...
    -- Brujo
    ["Increases the critical strike chance of your Destruction spells by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tus hechizos de Destrucción en un (%d+)%%.",
    ["Increases the critical strike chance of your Searing Pain spell by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tu hechizo Dolor abrasador en un (%d+)%%.",
    ["Reduces the chance for enemies to resist your Affliction spells by (%d+)%%."] = "Reduce la probabilidad de que los enemigos resistan tus hechizos de Aflicción en un (%d+)%%.",
    ["Firestone"] = "Piedra de Fuego",

    -- Mago
    ["Increases the critical strike chance of your Arcane Explosion and Arcane Missiles spells by an additional (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tus hechizos Explosión Arcana y Misiles Arcanos en un (%d+)%% adicionales.",
    ["Increases the critical strike chance of your Fire Blast and Scorch spells by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tus hechizos Explosión de Fuego y Llamarada en un (%d+)%%.",
    ["Increases the critical strike chance of your Flamestrike spell by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tu hechizo Lluvia de Fuego en un (%d+)%%.",
    ["Increases the critical strike chance of your Fire spells by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tus hechizos de Fuego en un (%d+)%%.",
    ["Increases the critical strike chance of all your spells against frozen targets by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de todos tus hechizos contra objetivos congelados en un (%d+)%%.",
    ["Increases your spell damage and critical srike chance by (%d+)%%."] = "Aumenta tu daño con hechizos y tu probabilidad de golpe crítico en un (%d+)%%.",
    ["Increases critical strike chance from Fire damage spells by (%d+)%%."] = "Aumenta la probabilidad de golpe crítico de tus hechizos de daño de Fuego en un (%d+)%%.",

    -- Sacerdote
    ["Reduces the chance for enemies to resist your Holy and Discipline spells by (%d+)%%."] = "Reduce la probabilidad de que los enemigos resistan tus hechizos Sagrados y de Disciplina en un (%d+)%%.",
    ["Increases the critical effect chance of your Holy and Discipline spells by (%d+)%%."] = "Aumenta la probabilidad de efecto crítico de tus hechizos Sagrados y de Disciplina en un (%d+)%%.",
    ["Increases your spell damage by %d+%% and the critical strike chance of your offensive spells by (%d)%%"] = "Aumenta tu daño con hechizos en %d+%% y la probabilidad de golpe crítico de tus hechizos ofensivos en un (%d)%%.",
    ...
    GLANCE_REDUCTION_COLON = "D.Desviado:",
    CRIT_CAP_COLON = "Cap/crítico:",
    BOSS_CRIT_COLON = "Crít/efectivo:",
    ...
    ["Equip: Improves your chance to get a critical strike with missile weapons by (%d)%%."] = "Equipar: Mejora tu probabilidad de golpe crítico con armas de proyectiles en un (%d)%%.",
    ["(%d)%% Spell Critical Strike"] = "(%d)%% Golpe crítico con hechizos",

    ["Increases spell critical chance by (%d)%%."] = "Aumenta la probabilidad de golpe crítico con hechizos en un (%d)%%.",
    ["Chance to get a critical strike with spells is increased by (%d+)%%"] = "La probabilidad de golpe crítico con hechizos aumenta en un (%d+)%%.",

    ["Equip: Increases your spell damage by up to (%d+) and your healing by up to %d+."] = "Equipar: Aumenta tu daño con hechizos en hasta (%d+) y tu sanación en hasta %d+.",
    ["Equip: Increases your spell damage by up to %d+ and your healing by up to (%d+)."] = "Equipar: Aumenta tu daño con hechizos en hasta %d+ y tu sanación en hasta (%d+).",
    ...
    ["Increased damage done by magical spells and effects by (%d+)."] = "Daño aumentado por hechizos y efectos mágicos en un (%d+).",
    ["Increases healing done by magical spells and effects by up to (%d+)."] = "Aumenta la sanación realizada por hechizos y efectos mágicos en hasta (%d+).",
    ...
    ["(%d+) Block"] = "(%d+) Bloqueo",
    ["Equip: Increases the block value of your shield by (%d+)."] = "Equipar: Aumenta el valor de bloqueo de tu escudo en un (%d+).",
    ["Block Value %+(%d+)"] = "Valor de bloqueo %+(%d+)",
    ["amount of damage absorbed by your shield by (%d+)%%"] = "Cantidad de daño absorbido por tu escudo en un (%d+)%%.",
    ["increases the amount blocked by (%d+)%%"] = "Aumenta la cantidad bloqueada en un (%d+)%%.",
    ["increases block amount by (%d+)%%"] = "Aumenta la cantidad de bloqueo en un (%d+)%%.",
    ["Block value increased by (%d+)."] = "Valor de bloqueo aumentado en un (%d+).",
